		...
		<div class="w-full max-w-md space-y-8">
			<div>
				...
				<h2 class="mt-6 text-center text-4xl font-bold tracking-tight text-gray-900">
					{{__('Sign up a new account')}}
				</h2>
			</div>

		<x-form class="mt-8 space-y-6 bg-white dark:bg-dark dark:text-white p-8 rounded-xl relative" action="{{ url('/register') }}" method="post">
			...
			<div class="flex flex-col">
				...
				<InputComponent v-model:value="form.password_confirmation" :confirm="form.password" type="password" :inputData="{
					...
					'front_icon' : true,
					'isHeader' : true,
					'placeholder' : '{{ trans_choice('Password', 1) }}',
			...
			<div class="flex items-center justify-between">
				<div class="flex items-center">
					...
					<label for="terms_policies" class="ml-2 block text-sm">
