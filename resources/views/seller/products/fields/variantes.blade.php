    ...
    <section aria-labelledby="variantes-cate-heading" aria-describedby="variantes-cate-details">
        ...
        <div class="flex flex-col w-full">
            <div class="flex flex-row space-x-3" v-for="i in variantes.cates" :key="i.id">
                ...
                <div v-if="variantes.cates.length > 1" class="flex flex-none w-10 h-10 border rounded-md dark:border-neutral-700 border-gray-300 shadow-md items-center justify-center" @click="deleteVarianteCate(i.id)" data-mdb-ripple="true" data-mdb-ripple-color="dark">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                            ...
                            <template #default="{ images, deleteImage }">
                                <div class="flex flex-wrap flex-row">
                                    ...
                                    <div class="w-24 h-24 rounded-md m-2 border border-gray-300 overflow-hidden flex justify-center items-center relative">
                                        <label for="variante-images" class="w-full h-full z-10 absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
