...
<section aria-labelledby="product-restrict-heading" aria-describedby="product-restrict-details">
    ...
    <div class="flex items-center">
        <input id="restrict_age" name="restrict_age" v-model="data.info.restric_age" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
...
<section aria-labelledby="product-fetch-heading" aria-describedby="product-fetch-details">
    ...
    <div class="flex flex-row">
        <InputComponent v-model:value="data.fetch_video" type="text" :inputData="{
            'name' : 'fetch_video',
            'isHeader' : false,
...
<section class="" aria-labelledby="product-ratings-heading" aria-describedby="product-ratings-details">
