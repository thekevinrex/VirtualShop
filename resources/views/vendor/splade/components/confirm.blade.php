<SpladeConfirm
    default-title="{{ trans('splade.confirm_title') }}"
    default-text=""
    default-password-text="{{ trans('splade.confirm_password') }}"
    default-confirm-button="{{ trans('splade.confirm') }}"
    default-cancel-button="{{ trans('splade.cancel') }}"
                                    ...
                                    <div class="text-center sm:mt-0 sm:text-left">
                                        ...
                                        <div class="mt-2 flex rounded-md border border-gray-300 shadow-sm" v-if="confirm.confirmPassword">
                                            <input
                                                type="password"
                                                name="password"
                                                placeholder="{{ trans('splade.passwrod') }}"
